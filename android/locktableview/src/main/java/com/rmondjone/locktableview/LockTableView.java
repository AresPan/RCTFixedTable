...
public class LockTableView {
    ...
    private void initAttrs() {
        ...
        mTableContentTextColor = R.color.beijin;
        mFristRowBackGroudColor = R.color.border_color;
        mTextViewSize = 16;
    }
    ...
    private void createLockColumnView() {
        ...
        for (int i = 0; i < mTableColumnDatas.size(); i++) {
            ...
            if (i % 2 == 0) {
                textViewContainer.setBackgroundColor(ContextCompat.getColor(mContext, R.color.light_gray));
            } else {
                textViewContainer.setBackgroundColor(ContextCompat.getColor(mContext, R.color.white));
            }
            ...
            ViewGroup.LayoutParams spliteLayoutParam = new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT,
                    DisplayUtil.dip2px(mContext, lineHeight));
        ...
        for (int i = 0; i < mTableRowDatas.size(); i++) {
            ...
            if (i % 2 == 0) {
                linearLayout.setBackgroundColor(ContextCompat.getColor(mContext, R.color.light_gray));
            } else {
            ...
            for (int j = 0; j < datas.size(); j++) {
                ...
                if (j != datas.size() - 1) {
                    ...
                    ViewGroup.LayoutParams splitViewParmas = new ViewGroup.LayoutParams(DisplayUtil.dip2px(mContext, lineHeight),
    ...
    private void createScollview(HorizontalScrollView scrollView, List<String> datas, boolean isFristRow) {
        ...
        for (int i = 0; i < datas.size(); i++) {
            ...
            ViewGroup.LayoutParams textViewParamsCopy = textView.getLayoutParams();
            if (isLockFristColumn) {
                textViewParamsCopy.width = DisplayUtil.dip2px(mContext, mColumnMaxWidths.get(i + lineHeight));
            } else {
